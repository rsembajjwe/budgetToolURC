...
public class DepartmentGeneralPhysicalPerformanceService {
    ...
    public DepartmentGeneralPhysicalPerformance getOrCreate(String code, String name) {
    ...
    public DepartmentGeneralPhysicalPerformance saveQuarter(
        ...
        DepartmentGeneralPhysicalPerformance entity = repository.findByCode(code)
                .orElseGet(() -> {
        ...
        switch (quarter.toLowerCase()) {
            case "qtr1" -> entity.setQtr1(html);
            case "qtr2" -> entity.setQtr2(html);
            case "qtr3" -> entity.setQtr3(html);
            case "qtr4" -> entity.setQtr4(html);
    ...
    @Transactional(readOnly = true)
    public String getQuarterHtml(String code, String quarter) {
        return repository.findByCode(code)
                .map(entity -> switch (quarter.toLowerCase()) {
                    case "qtr1" -> entity.getQtr1();
                    case "qtr2" -> entity.getQtr2();
                    case "qtr3" -> entity.getQtr3();
                    case "qtr4" -> entity.getQtr4();
                    default -> "";
                })
                .orElse("");
    }
