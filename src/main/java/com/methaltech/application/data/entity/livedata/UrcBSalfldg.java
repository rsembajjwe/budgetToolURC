...
@Entity
@Table(name = "URC_B_SALFLDG")
public @Data class UrcBSalfldg implements Serializable {

    @EmbeddedId
    private UrcBSalfldgId id;

    @Column(name = "AMOUNT", nullable = false)
    private BigDecimal amount;

    @Column(name = "D_C", nullable = false)
    private String dc;
    ...
    @Column(name = "ALLOC_DATETIME", nullable = false)
    ...
    private String supplmntryExtsn;
