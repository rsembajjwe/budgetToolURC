...
public class BudgetFormView extends Div {
    ...
    public BudgetFormView(AuthenticatedUser authenticatedUser, BudgetService chosenBudgetService, Urc_ActivitiesService sampleUrc_ActivitiesService,
        ...
        //This code iuploads budget with all columns present
    ...
    if (cel4 != null && cel4.getCellType() == CellType.STRING) {
        ...
        String stringValue = decimalFormat.format(cel4.getNumericCellValue()).replace(",", "");
        try {
            qty2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
    ...
    if (cel7 != null && cel7.getCellType() == CellType.STRING) {
        ...
        try {
            jul2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 7);
            m.setMessage(stringValue + ":     Invalid Value");
            mes.add(m);
        }
        ...
        String stringValue = decimalFormat.format(cel7.getNumericCellValue()).replace(",", "");
        try {
            jul2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
    ...
    if (cel8 != null && cel8.getCellType() == CellType.STRING) {
        ...
        try {
            ...
            aug2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 8);
            m.setMessage(stringValue + ":     Invalid Value");
            mes.add(m);
        }
        ...
        String stringValue = decimalFormat.format(cel8.getNumericCellValue()).replace(",", "");
        try {
    ...
    if (cel9 != null && cel9.getCellType() == CellType.STRING) {
        ...
        try {
            sep2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 9);
            m.setMessage(stringValue + ":     Invalid Value");
            mes.add(m);
        }
        ...
        String stringValue = decimalFormat.format(cel9.getNumericCellValue()).replace(",", "");
        try {
            sep2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
    ...
    if (cel10 != null && cel10.getCellType() == CellType.STRING) {
        ...
        try {
            oct2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 10);
            m.setMessage(stringValue + ":     Invalid Value");
            mes.add(m);
        }
        ...
        String stringValue = decimalFormat.format(cel10.getNumericCellValue()).replace(",", "");
        try {
            oct2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
    ...
    if (cel11 != null && cel11.getCellType() == CellType.STRING) {
        ...
        try {
            nov2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 11);
            m.setMessage(stringValue + ":     Invalid Value");
            mes.add(m);
        }
        ...
        String stringValue = decimalFormat.format(cel11.getNumericCellValue()).replace(",", "");
        try {
            nov2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
    ...
    if (cel12 != null && cel12.getCellType() == CellType.STRING) {
        ...
        try {
            dec2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 12);
            m.setMessage(stringValue + ":     Invalid Value");
            mes.add(m);
        }
        ...
        String stringValue = decimalFormat.format(cel12.getNumericCellValue()).replace(",", "");
        try {
            dec2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
    ...
    if (cel13 != null) {
    String stringValue = "";
    if (cel13.getCellType() == CellType.STRING) {
        stringValue = cel13.getStringCellValue().replace(",", "");
    }
    if (cel13.getCellType() == CellType.NUMERIC) {
        // Format numeric value without scientific notation
        
        stringValue = decimalFormat.format(cel13.getNumericCellValue()).replace(",", "");
    }
    
    //System.out.println("DEBUG: Cell Value: " + stringValue + "  Row:" + i);
    if (!stringValue.isEmpty()) {
        try {
            jan2 = new BigDecimal(stringValue);
            // Your code here
        } catch (NumberFormatException e) {
            m = new errorMessages();
            m.setRow("Row: " + i + " Column: " + 13);
            m.setMessage(stringValue + ":x     Invalid Value");
            mes.add(m);
        }
    }
...
if (cel14 != null && cel14.getCellType() == CellType.STRING) {
    ...
    try {
        feb2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
        m = new errorMessages();
        m.setRow("Row: " + i + " Column: " + 14);
        m.setMessage(stringValue + ":     Invalid Value");
        mes.add(m);
    }
    
} else if (cel14 != null && cel14.getCellType() == CellType.NUMERIC) {
    String stringValue = decimalFormat.format(cel14.getNumericCellValue()).replace(",", "");
    try {
        feb2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
...
if (cel15 != null && cel15.getCellType() == CellType.STRING) {
    ...
    try {
        mar2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
        m = new errorMessages();
        m.setRow("Row: " + i + " Column: " + 15);
        m.setMessage(stringValue + ":     Invalid Value");
        mes.add(m);
    }
    
} else if (cel15 != null && cel15.getCellType() == CellType.NUMERIC) {
    String stringValue = decimalFormat.format(cel15.getNumericCellValue()).replace(",", "");
    try {
        mar2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
...
if (cel16 != null && cel16.getCellType() == CellType.STRING) {
    ...
    try {
        apr2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
        m = new errorMessages();
        m.setRow("Row: " + i + " Column: " + 16);
        m.setMessage(stringValue + ":     Invalid Value");
        mes.add(m);
    }
    
} else if (cel16 != null && cel16.getCellType() == CellType.NUMERIC) {
    String stringValue = decimalFormat.format(cel16.getNumericCellValue()).replace(",", "");
    try {
        apr2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
...
if (cel17 != null && cel17.getCellType() == CellType.STRING) {
    ...
    try {
        may2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
        m = new errorMessages();
        m.setRow("Row: " + i + " Column: " + 17);
        m.setMessage(stringValue + ":     Invalid Value");
        mes.add(m);
    }
    
} else if (cel17 != null && cel17.getCellType() == CellType.NUMERIC) {
    String stringValue = decimalFormat.format(cel17.getNumericCellValue()).replace(",", "");
    try {
        may2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
...
if (cel18 != null && cel18.getCellType() == CellType.STRING) {
    ...
    try {
        jun2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
        m = new errorMessages();
        m.setRow("Row: " + i + " Column: " + 18);
        m.setMessage(stringValue + ":     Invalid Value");
        mes.add(m);
    }
    
} else if (cel18 != null && cel18.getCellType() == CellType.NUMERIC) {
    String stringValue = decimalFormat.format(cel18.getNumericCellValue()).replace(",", "");
    try {
        jun2 = new BigDecimal(stringValue);
        // Your code here
    } catch (NumberFormatException e) {
